...
Design settled 2026-08-19. **Nothing here is built yet** — this doc records the agreed
architecture and staging so implementation sessions can start from decisions, not
re-derivation. It extends the shipped backup system described in
