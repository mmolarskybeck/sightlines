...
- Dropbox-folder sync (PKCE + offline access, app-folder-scoped — §6); the backup half shipped 2026-07-19 via the §11 storage-safety slice (technical-pilot stage). Additional providers (Drive/OneDrive/Box): see `docs/cloud-backup-providers.md` for approval landscape + rollout staging
