...
- Dropbox backup (PKCE + offline access, App Folder-scoped — §6) shipped 2026-07-19 and is in technical pilot via the §11 storage-safety slice. Folder-level sync semantics remain a separate follow-up. Additional providers (Drive/OneDrive/Box): see `docs/cloud-backup-providers.md` for approval landscape + rollout staging.
